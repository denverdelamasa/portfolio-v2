  ...
  return (
    <main className="flex flex-col w-full h-full overflow-x-hidden md:overflow-x-visible">
      ...
      <section className="flex flex-col lg:flex-row gap-x-2 pt-12">
        <aside className="w-full lg:w-3/7 2xl:w-2/4 lg:sticky lg:top-0 h-fit lg:h-[100vh]">
          <ProfileCard />
        </aside>
      ...
      <section className="flex h-fit w-full text-center justify-center items-center">
        <Contact />
      </section>
    </main>
  );
