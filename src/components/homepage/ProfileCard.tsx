...
export default function ProfileCard() {
  ...
  return (
    <section id="profile" className="flex flex-col text-3xl h-full items-center justify-start gap-y-2">
      <div className="m-auto card w-76 lg:w-92 shadow-xl backdrop-blur-xs hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
        <figure className="pt-4 px-4">
            <div className="w-full h-32 bg-gradient-to-r from-primary to-success rounded-t-xl"></div>
        </figure>
