...
const ExperienceCard: React.FC<ExperienceCardProps> = ({
  ...
  return (
    <div className="flex flex-col md:flex-row hover:backdrop-blur-[2px] transition-all duration-300 ease-in-out hover:shadow-xl rounded-xl">
      <div className="p-8 justify-center overflow-hidden align-top hidden md:block w-2/8">
