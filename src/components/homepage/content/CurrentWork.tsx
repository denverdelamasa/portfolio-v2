    ...
    <section id="experiences" className="hero flex flex-col text-3xl w-full h-fit items-start px-4">
      <div className="hero-content flex flex-col mb-4 items-start text-start">
        ...
        <div className="grid grid-cols-1 w-full mt-8 gap-y-18">
            <div className="flex flex-col p-2 backdrop-blur-[2px] hover:backdrop-brightness-130 hover:backdrop-saturate-150 active:backdrop-brightness-130 active:backdrop-saturate-150 transform hover:-translate-y-1 active:-translate-y-1 transition-all duration-300 ease-in-out hover:shadow-xl rounded-xl">
                <img src="https://jrscomputer.com/wp-content/uploads/2025/02/Screenshot_2025-02-03-09-35-49-307_com.android.chrome-edit-removebg-preview-300x175.webp" className="max-h-42 w-full object-contain"></img>
